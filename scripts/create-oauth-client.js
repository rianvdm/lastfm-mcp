...
const baseUrl = environment === 'prod' ? 'https://lastfm-mcp-prod.rian-db8.workers.dev' : 'http://localhost:8787'
...
try {
	...
	console.log(
		`3. Test OAuth flow at: ${baseUrl}/oauth/authorize?client_id=${client.id}&redirect_uri=https://claude.ai/oauth/callback&response_type=code&scope=read:listening-history`,
	)
} catch (error) {

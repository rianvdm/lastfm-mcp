...
export const PUBLIC_TOOL_CATALOG: ToolListEntry[] = [
	...
	{ name: 'get_artist_top_tracks', summary: "Get an artist's globally most-played tracks" },
	{ name: 'get_artist_top_albums', summary: "Get an artist's globally most-played albums" },
...
export const AUTHENTICATED_TOOL_CATALOG: ToolListEntry[] = [
	...
	{ name: 'get_top_tracks', summary: 'Get your top tracks by time period' },

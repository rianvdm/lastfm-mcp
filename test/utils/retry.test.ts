...
describe('Retry Utility', () => {
	...
	describe('fetchWithRetry', () => {
		it('should retry on 429 status', async () => {
			...
			globalThis.fetch = vi.fn().mockResolvedValueOnce(mockResponse429).mockResolvedValueOnce(mockResponseOk)
		...
		it('should retry on 5xx errors', async () => {
			...
			globalThis.fetch = vi.fn().mockResolvedValueOnce(mockResponse500).mockResolvedValueOnce(mockResponseOk)
